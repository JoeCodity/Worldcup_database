...
echo "$($PSQL "select t.name from teams t inner join games g on t.team_id = g.winner_id or t.team_id = g.opponent_id where g.round = 'Eighth-Final' and g.year = '2014' order by name")"
